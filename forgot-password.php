    ...
    if (mysqli_num_rows(mysqli_query($conn, "SELECT * FROM users WHERE email='{$email}'")) > 0) {
        ...
        if ($query) {        
            ...
            try {
                ...
                //Recipients
                $mail->setFrom("your-email@gmail.com", "ANATRICIA COFFEE");
...
<body>
    <div class="cont_log">
        ...
        <form action="" method="post">
            ...
            <input type="text" class="email" name="email" placeholder="Enter Your Email" required><br><br>
            <button name="submit" class="loginbtn" type="submit" style = "width: 130px">Send Reset Link</button>
        </form>
